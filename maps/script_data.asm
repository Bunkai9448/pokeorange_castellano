...
SECTION "Pokemon Center Scripts 6", ROMX


SECTION "Cable Club Scripts", ROMX
...
SECTION "Mandarin North Scripts", ROMX
...
SECTION "Pinkan and Fukuhara Scripts", ROMX
...
SECTION "Wrecked Ship Scripts", ROMX
...
SECTION "Fishing Contest Scripts", ROMX
...
SECTION "Trovitopolis Scripts 1", ROMX
...
SECTION "Trovitopolis Scripts 2", ROMX
...
SECTION "Trovitopolis Dept. Store Scripts", ROMX
...
SECTION "Cleopatra Scripts", ROMX
...
INCLUDE "maps/KumquatHotelBottomRoom2.asm"
INCLUDE "maps/KumquatHotelBottomRoom3.asm"
...
INCLUDE "maps/LightningIslandCave.asm"
