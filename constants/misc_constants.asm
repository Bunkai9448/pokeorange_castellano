...
NUM_MON_SUBMENU_ITEMS EQU 8
	...
	const_def
	const CORAL_EYE_BADGE
	const SEA_RUBY_BADGE
	const SPIKE_SHELL_BADGE
	const JADE_STAR_BADGE
...
DUSK_HOUR EQU 17 ; 5:00 PM - 5:59 PM
	...
	const FISHGROUP_CONTEST
	const FISHGROUP_RIND
